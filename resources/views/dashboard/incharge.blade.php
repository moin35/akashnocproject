...
<div class=" row">
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="{!!$mecounnoc!!} new messages." class="well top-block" href="{{URL::to('inchargemsg')}}">
            <i class="glyphicon glyphicon-envelope red"></i>

            <div>Messages From NOC</div>
            <div>{!!$mecounnoc!!}</div>
            <span class="notification red">{!!$mecounnoc!!}</span>
        </a>
    </div>
</div>
<div class="row">
